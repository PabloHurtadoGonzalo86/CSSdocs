...
!!! warning "No uses unidades absolutas para `font-size`"
...
!!! warning "Accesibilidad: cuidado con la diferencia entre el mínimo y el máximo en `clamp()` para texto"
