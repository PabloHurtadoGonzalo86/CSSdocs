...
!!! warning "Accesibilidad: el máximo debe ser al menos el doble del mínimo"
...
- El primer bloque evita el clásico "se me sale 20px por culpa del padding" descrito arriba (más detalle en [El modelo de caja](../fundamentos/modelo-de-caja.md)).
...
!!! warning "`overflow-x: hidden` es un parche, no un diagnóstico"
