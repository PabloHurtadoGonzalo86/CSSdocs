# Tipografía: fuentes y propiedades de texto
...
!!! warning "Accesibilidad de los pesos muy finos"
...
!!! warning "No abuses de `letter-spacing`"
...
!!! warning "Accesibilidad de `justify`"
...
!!! warning "Accesibilidad de `uppercase` en bloques largos"
...
- [Colores en CSS](../fundamentos/colores.md)
- [Overflow y desbordamiento](../layout/overflow.md)
- [Unidades y funciones responsivas](../responsive/unidades-y-funciones.md)
