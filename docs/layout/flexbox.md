...
!!! warning "`row-reverse` y `column-reverse` afectan a la accesibilidad"
...
!!! warning "`order` no cambia el orden de lectura ni de tabulación"
...
- [Cheatsheet de Flexbox](../cheatsheets/flexbox-cheatsheet.md)
