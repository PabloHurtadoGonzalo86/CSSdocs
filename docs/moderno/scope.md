...
!!! warning "El peso de `&` dentro de `@scope` puede variar entre navegadores"
...
- [Arquitectura y metodologías CSS](../arquitectura/metodologias-y-organizacion.md)
