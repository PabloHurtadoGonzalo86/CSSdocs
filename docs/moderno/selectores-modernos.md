# Selectores modernos: `:has()`, `:is()`, `:where()`
...
!!! warning "Restricción: no aceptan pseudo-elementos"
...
!!! warning "Cuidado con el rendimiento en anclas muy amplias"
