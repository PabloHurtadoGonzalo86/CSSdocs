---
title: Layout multi-columna
description: "Guía sobre el layout multi-columna (multicol) de CSS: uso de column-count, column-width, columns, column-gap, column-rule, control de saltos, column-span, column-fill y cuándo elegir multicol frente a Flexbox o Grid."
---
...
:::caution[El valor inicial de `column-rule-style` es `none`]
...
:::caution[`column-fill` depende de que el contenedor tenga una altura definida]
...
:::caution[Cuidado con combinar altura fija y multicol]
...
- [Flexbox](flexbox)
- [CSS Grid](grid)
- [Overflow y desbordamiento](overflow)
- [Fuentes y texto](../tipografia/fuentes-y-texto)
