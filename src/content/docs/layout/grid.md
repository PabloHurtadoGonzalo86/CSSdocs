...
description: Guía completa de CSS Grid Layout que cubre la creación de contenedores grid, columnas y filas, la unidad fr, repeat(), minmax(), gap, áreas nombradas, posicionamiento por líneas, grid explícito e implícito, alineación de items/contenido y subgrid.
---
...
- [Grid — cheatsheet](../cheatsheets/grid-cheatsheet)
