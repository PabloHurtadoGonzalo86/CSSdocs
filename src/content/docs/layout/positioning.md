...
description: Guía sobre la propiedad position (static, relative, absolute, fixed, sticky), las propiedades de desplazamiento top/right/bottom/left e inset, el containing block y el contexto de apilamiento con z-index.
---
...
:::caution[Un ancestro con transform, filter o will-change puede 'romper' el fixed]
...
- [Flexbox](flexbox)
- [Transform](../animaciones/transform)
