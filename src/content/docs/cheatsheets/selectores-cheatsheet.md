---
title: "Cheatsheet: Selectores CSS"
description: Chuleta de referencia rápida con los selectores CSS más usados (básicos, de atributo, combinadores, pseudo-clases y pseudo-elementos), su sintaxis, qué eligen del DOM y su soporte en navegadores.
---

Chuleta de referencia rápida con los selectores más usados en CSS: qué sintaxis tienen y qué eligen del DOM, en una línea por selector. Está pensada para consultarla mientras escribes CSS —sin explicaciones largas—, no para aprender el modelo desde cero: si necesitas entender el *por qué* detrás de cada uno (especificidad, combinadores, listas "perdonadoras"...), la [guía completa de selectores](../fundamentos/selectores) y la de [selectores modernos](../moderno/selectores-modernos) cubren eso en profundidad.
...
- [Selectores: guía completa](../fundamentos/selectores)
