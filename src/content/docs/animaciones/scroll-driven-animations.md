---
title: Scroll-driven animations (animaciones basadas en scroll)
description: Guía sobre animation-timeline, scroll() y view() para crear animaciones CSS controladas por el progreso del scroll, con ejemplos de barra de progreso de lectura y tarjetas que aparecen al hacer scroll.
---
...
:::caution[Declárala después del shorthand `animation`]
