---
title: "Transform: mover, rotar, escalar"
description: "Guía de la propiedad transform en CSS para mover, rotar, escalar e inclinar elementos en 2D y 3D, cubriendo el orden de las funciones, transform-origin, perspective y transform-style."
---
...
:::caution[Un `transform` distinto de `none` crea un nuevo contexto de apilamiento]
