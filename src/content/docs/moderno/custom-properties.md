...
description: Explica las custom properties de CSS (declaración con --nombre, uso con var() y fallbacks, cascada y herencia, alcance con :root o local, y un caso práctico de theming claro/oscuro con prefers-color-scheme).
---
...
:::caution[Qué pasa sin fallback y sin valor válido]
...
- [Color moderno (oklch, color-mix)](color-moderno)
