...
Esto es coherente con cómo se explica la especificidad de `:is()` en [Cascada, herencia y especificidad](../fundamentos/cascada-especificidad-herencia): `&`, al igual que `:is()`, toma el peso del argumento más específico, no lo ignora y no lo suma aparte.
...
:::caution[Historia: no siempre fue tan permisivo]
...
:::caution[El orden de las declaraciones ahora puede importar]
