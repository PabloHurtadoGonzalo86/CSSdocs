...
description: Explica las cuatro capas del modelo de caja CSS (content, padding, border, margin), la diferencia entre content-box y border-box, el colapso de márgenes y la diferencia entre outline y border.
---
...
:::caution[No elimines el outline sin reemplazo]
